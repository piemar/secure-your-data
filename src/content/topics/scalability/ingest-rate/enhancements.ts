...
/**
 * Ingest Rate Enhancement Metadata
 * 
 * Source PoV Proof Exercise: Docs/pov-proof-exercises/proofs/03/README.md (INGEST-RATE)
 */

export const enhancements: EnhancementMetadataRegistry = {
  'ingest-rate.cluster-setup': {
    id: 'ingest-rate.cluster-setup',
    povCapability: 'INGEST-RATE',
...
measureIngestionRate().catch(console.error);`,
  ...
  'ingest-rate.ordered-vs-unordered': {
    id: 'ingest-rate.ordered-vs-unordered',
    povCapability: 'INGEST-RATE',
    sourceProof: 'proofs/03/README.md',
    sourceSection: 'Execution',
    codeBlocks: [
...
testWriteConcern().catch(console.error);`,
  ...
  'ingest-rate.monitor-replication': {
    id: 'ingest-rate.monitor-replication',
    povCapability: 'INGEST-RATE',
    sourceProof: 'proofs/03/README.md',
    sourceSection: 'Execution',
    codeBlocks: [
