...
export const lab3Definition: WorkshopLabDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      instructions: 'Create DEKs for multiple tenants with unique keyAltNames (e.g. tenant-1-ssn-key, tenant-2-ssn-key).\nInsert encrypted data for each tenant using their respective DEKs.\nUse Run all or Run selection in the editor to run the script.\nClick Check progress or Next to verify.',
      estimatedTimeMinutes: 15,
      modes: ['demo', 'lab', 'challenge'],
    ...
    },
    {
      ...
      instructions: 'Create a script that locates the DEK by keyAltName and uses ClientEncryption.rewrapManyDataKey() to rewrap it with a (simulated) new CMK alias.\nUse Run all or Run selection in the editor to run the script.\nClick Check progress or Next to verify.',
      estimatedTimeMinutes: 15,
      modes: ['lab', 'challenge'],
