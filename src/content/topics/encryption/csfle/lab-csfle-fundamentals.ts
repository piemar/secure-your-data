...
export const lab1Definition: WorkshopLabDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      instructions: 'Get your Key ID and IAM identity.\nCreate a Key Policy JSON file that allows your account root and IAM user full access.\nApply the policy to your CMK.\nClick Check progress or Next to verify.',
    ...
    },
    {
      ...
      instructions: 'Connect to Atlas using mongosh and switch to the encryption database.\nCreate a unique partial index on the __keyVault collection.\nClick Check progress or Next to verify.',
      estimatedTimeMinutes: 5,
      modes: ['lab', 'challenge'],
    ...
    },
    {
      ...
      instructions: 'Create a Node.js script (createKey.cjs) that configures KMS providers and uses ClientEncryption.createDataKey() to generate and store the DEK.\nUse Run all or Run selection in the editor to run the script.\nClick Check progress or Next to verify.',
    ...
    },
    {
      ...
      instructions: 'Connect to Atlas and switch to the encryption database.\nQuery the __keyVault collection and confirm you see a document with your keyAltName.\nUse Run all or Run selection in the editor to run the verification script.\nClick Check progress or Next to verify.',
      estimatedTimeMinutes: 5,
      modes: ['demo', 'lab', 'challenge'],
      verificationId: 'csfle.verifyDekCreated',
      points: 5,
    ...
    },
    {
      ...
      instructions: 'Review the complete application code (CMK, DEK, schema map, automatic encryption).\nUse Run all or Run selection in the editor to run the application.\nClick Check progress or Next to verify.',
      estimatedTimeMinutes: 10,
      modes: ['demo', 'lab'],
