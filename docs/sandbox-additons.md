> **Superseded for planning:** Use **[sandbox-strategy-final.md](./sandbox-strategy-final.md)** as the authoritative sandbox and execution document. This file remains as supplemental detail on three-tier validation and cloud missions.
