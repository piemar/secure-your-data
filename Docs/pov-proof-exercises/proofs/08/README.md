...
* In the project's Security tab, choose to add a new user called __main_user__, and for __Built-in Role__ specify __Atlas admin__ (make a note of the password you specify)
* Create an __M20__ based 3 node replica-set in a single cloud provider region of your choice with with default settings
* In the Security tab, add a new __IP Access List__ entry for your laptop's current IP address
