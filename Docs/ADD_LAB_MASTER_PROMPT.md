...
- **Lab overview (intro tab):** Use external research and the source doc to create the **overview page** for each lab: **whatYouWillBuild** (3–6 bullets), **keyInsight** (1–2 sentences), and **keyConcepts** (4+). The overview is the first thing attendees see; it must be accurate and compelling. Include these fields in the lab definition so the intro tab renders correctly.
